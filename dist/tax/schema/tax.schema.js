...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], TaxCategory.prototype, "type", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], TaxCategory.prototype, "level", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], TaxCategory.prototype, "fullDescription", void 0);
exports.TaxCategory = TaxCategory = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true }) // createdAt & updatedAt auto-added
    ,
    (0, mongoose_1.Schema)()
], TaxCategory);
